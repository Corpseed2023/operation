...
public interface PurchaseOrderRepository
        extends JpaRepository<ProcurementOrder, Long> {

    Optional<ProcurementOrder> findByProcurementAssignmentId(
    ...
    Page<ProcurementOrder> findByCreatedByAndIsDeletedFalse(
            Long createdBy,
            Pageable pageable
    );
}