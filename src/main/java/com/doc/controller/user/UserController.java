...
@RestController
@RequestMapping("/operationService/api/users")
public class UserController {
    ...
    @Operation(summary = "Get all users based on the requesting user's role and permissions")
    @ApiResponses({
    ...
    public ResponseEntity<List<UserResponseDto>> getAllUsers(
        ...
        List<UserResponseDto> users = userService.getAllUsers(page, size, userId);
