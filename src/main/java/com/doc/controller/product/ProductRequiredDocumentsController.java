...
public class ProductRequiredDocumentsController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProductRequiredDocumentsResponseDto> getRequiredDocumentById(@PathVariable Long id) {
        ProductRequiredDocumentsResponseDto response = requiredDocumentsService.getRequiredDocumentById(id);
    ...
    public ResponseEntity<List<ProductRequiredDocumentsResponseDto>> getAllRequiredDocuments(
        ...
        List<ProductRequiredDocumentsResponseDto> responses = requiredDocumentsService.getAllRequiredDocuments(page, size, name, type, country, centralName, stateName);
